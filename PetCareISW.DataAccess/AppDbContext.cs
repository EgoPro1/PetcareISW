...
namespace PetCareISW.DataAccess
{
    public class AppDbContext: DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseMySQL("Server=bmzmz8tqsbzrbabzqbky-mysql.services.clever-cloud.com;userid=uasg086y6t1fw9vk;Password=ZoDsRtwM2JZwUfeLeNri;Database=bmzmz8tqsbzrbabzqbky;");
